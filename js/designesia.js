...
(function ($) {
   ...
   * --------------------------------------------------*/
  var local_rtl = localStorage.getItem("rtl");
  console.log(window.location.pathname);
  var isEnglishPage =
    window.location.pathname.includes("_ar") ||
    window.location.pathname === "/" ||
    window.location.pathname === "/index.html"
      ? false
      : true;
  console.log(isEnglishPage);
  // var rtl_mode = local_rtl !== "on" && local_rtl !== "off" ? "on" : local_rtl; // on - for enable RTL, off - for deactive RTL
  var rtl_mode = isEnglishPage ? "off" : "on";
  ...
  function load_owl() {
    ...
    jQuery("#owl-software").owlCarousel({
      center: true,
      items: 4,
      loop: true,
      dots: true,
